...
public class Exercise2Test extends CompanyDomainForKata
{
    ...
    public void getCustomerCities()
    {
         ...
         * constant on {@link Customer}.
         */
        MutableList<String> customerCities = company.getCustomers().collect(Customer.TO_CITY);
    ...
    {
        MutableList<Customer> customersFromLondon = this.company.getCustomers().select(Predicates.attributeEqual(Customer.TO_CITY, "London"));
