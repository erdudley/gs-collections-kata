...
public class Exercise5Test extends CompanyDomainForKata
{
    ...
    public void whoSuppliesSandwichToaster()
    {
        ...
        Predicate<Supplier> suppliesToaster = Predicates.attributeEqual(new Function<Supplier,Boolean>(){

			public Boolean valueOf(Supplier supplier) {
				return ArrayIterate.contains(supplier.getItemNames(), "sandwich toaster");
			}
